...
class GestorPeliculas{
    fun obtenerPeliculas(): List<Peliculas> {
        ...
        peliculas.add(Peliculas("MORBIUS", "24:00","Hay algunas cosas en la vida que no se puede describir, uno las tiene que EXPERIMENTAR. Magnum opus de Sony Studios. Una demostración de verdadera pasión por el arte y el cine. Recordatorio de que personas como Martin Scorsese se equivocan con el cine de spuerherores."))
        return peliculas
    }
}